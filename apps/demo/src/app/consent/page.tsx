...
export default async function ConsentPage({ searchParams }: { searchParams: Promise<unknown> }) {
  const { class_code_valid } = routes.consent.$parseSearchParams(await searchParams);
  ...
  return (
    <>
      ...
      <ConsentForm
        user={user}
        value={user.consentGiven === null ? undefined : user.consentGiven ? "yes" : "no"}
      />
    </>
  );
}
      ...
      <div className="flex max-w-3xl flex-col gap-6 rounded-lg border-4 px-6 py-4 shadow-md">
        <div className="space-y-2">
          ...
          <div className="flex flex-col items-center justify-center gap-1.5 text-muted-foreground">
            <p>
              <span className="font-bold">Title:</span> Intelligent Textbook Assessment
            </p>
            <p>
              <span className="font-bold">Principal Investigator:</span> Scott Crossley
            </p>
          </div>
        </div>
        ...
        <FormSection id="study-purpose" title="Purpose of the Study">
          <p>
            The purpose of this study is to collect data from trainees using an intelligent training
            text which focuses on read-to-write tasks. Read-to-write tasks like summaries and short
            answer-questions are a common approach for assessing learning. Activities within an
            intelligent text should support interactive learning for a variety of complex subjects
            and provide students with opportunities to better comprehend the material. We hope to
            assess this in the current data collection.
          </p>
        </FormSection>

        <FormSection id="procedures" title="Procedures">
          <p>
            You are being asked to take part in a research study. If you decide to take part, you
            will:
          </p>
          <ol className="list-disc space-y-3 pl-6">
            ...
            <li>
              Take a survey on engagement, motivation, and user experience that focuses on user
              experiences with intelligent texts
            </li>
          </ol>
        ...
        <FormSection id="risks" title="Risks">
          <p>
            This study involves no more than minimal risk and involves no more risk than experienced
            in a normal day.
          </p>
        </FormSection>
        ...
        <FormSection id="benefits" title="Benefits">
          <p>
            You will gain experience in the research process. Your interaction with the intelligent
            textbook may lead to greater learning relative to a static electronic textbook. Your
            participation will help researchers and educators better understand successful
            summarization.
          </p>
        </FormSection>

        <FormSection id="voluntary-participation" title="Voluntary Participation and Withdrawal">
          <p>
        ...
        <FormSection id="contact" title="Contact">
          <p>
            ...
            <a href="mailto:scott.crossley@vanderbilt.edu" className="font-medium">
          ...
          <p>
            For additional information about your rights as a participant in the study, to discuss
            problems, concerns, and questions, please feel free to contact the Institutional Review
